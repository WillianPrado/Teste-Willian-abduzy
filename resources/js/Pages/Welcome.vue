<template>
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-220 sm:items-center sm:pt-0">
        <div v-if="canLogin" class="fixed top-45 justfy px-6 py-4 sm:block">
